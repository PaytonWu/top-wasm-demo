...
public:
    ...
    explicit xtop_state_accessor(void * handle);
    ...
    /// @return The state accessor object.
    static std::unique_ptr <xtop_state_accessor>
    build_from(common::xaccount_address_t const &account_address, std::error_code &ec);
    ...
    /// @return The state accessor object.
    static std::unique_ptr <xtop_state_accessor>
    build_from(common::xaccount_address_t const &account_address, std::uint64_t const height);
    ...
    /// @return The state accessor object.
    static std::unique_ptr <xtop_state_accessor>
    build_from(common::xaccount_address_t const &account_address, std::uint64_t const height, std::error_code &ec);
    ...
    xtoken_t
    withdraw(properties::xproperty_identifier_t const &property_id, common::xsymbol_t const &symbol, uint64_t amount,
             std::error_code &ec);
    ...
    /// @param ec Log the error code in the operation.
    /// @return The balance.
    uint64_t balance(properties::xproperty_identifier_t const &property_id, common::xsymbol_t const &symbol,
    ...
    typename properties::xtype_of_t<PropertyTypeV>::type
    get_property(properties::xtypeless_property_identifier_t const &property_id, std::error_code &ec) const;
    ...
    template <properties::xproperty_type_t PropertyTypeV>
    typename properties::xtype_of_t<PropertyTypeV>::type
    get_property(properties::xtypeless_property_identifier_t const &property_id,
                 common::xaccount_address_t const &address, std::error_code &ec) const;
    ...
    /// @param ec Log the error code in the operation.
    template <properties::xproperty_type_t PropertyTypeV>
    void set_property(properties::xtypeless_property_identifier_t const &property_id,
                      typename properties::xtype_of_t<PropertyTypeV>::type const &value, std::error_code &ec);
    ...
    /// @param ec Log the error code in the operation.
    template <properties::xproperty_type_t PropertyTypeV, typename std::enable_if<
            PropertyTypeV == properties::xproperty_type_t::map ||
    ...
    template <properties::xproperty_type_t PropertyTypeV, typename std::enable_if<
            PropertyTypeV == properties::xproperty_type_t::map ||
            PropertyTypeV == properties::xproperty_type_t::deque>::type * = nullptr>
    typename properties::xvalue_type_of_t<PropertyTypeV>::type
    get_property_cell_value(properties::xtypeless_property_identifier_t const &property_id,
                            typename properties::xkey_type_of_t<PropertyTypeV>::type const &key,
                            std::error_code &ec) const;
    ...
    template <properties::xproperty_type_t PropertyTypeV, typename std::enable_if<
            PropertyTypeV == properties::xproperty_type_t::map ||
            PropertyTypeV == properties::xproperty_type_t::deque>::type * = nullptr>
    void remove_property_cell(properties::xtypeless_property_identifier_t const &property_id,
                              typename properties::xkey_type_of_t<PropertyTypeV>::type const &key, std::error_code &ec);
...
private:
    bool read_permitted(properties::xproperty_identifier_t const &property_id) const

    noexcept;

    bool write_permitted(properties::xproperty_identifier_t const &property_id) const

    noexcept;

    bool read_permitted(std::string const &property_full_name) const
